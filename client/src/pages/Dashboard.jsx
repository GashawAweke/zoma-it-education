...
const Dashboard = () => {
  ...
  const {
    ...
    initialData: [
      {
        ...
        description:
          'Learn about basic computer components and their functions.',
        progress: 75,
        chapters: [
      ...
      },
      {
        ...
        description:
          'Learn proper typing techniques and practice with fun exercises.',
        progress: 30,
        chapters: [
      ...
      },
      {
        ...
        description:
          'Learn how to organize your files and folders effectively.',
        progress: 0,
        chapters: [
          {
            id: '3-1',
    ...
    enabled: !!user?.grade,
    onError: (err) => {
      toast(`Error loading courses: ${err.message}`, 'error');
    },
  });
          ...
          <aside className='md:w-1/4'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Grade Level: {user?.grade || 'Not set'}
                </CardDescription>
              </CardHeader>
              <CardContent>
